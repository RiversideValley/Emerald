...
public sealed class InstallationStateStore : IInstallationStateStore
{
    ...
    public string GetReceiptPath(Game game)
    {
        return Path.Combine(game.Path.BasePath, ".emerald", "install-state.v1.json");
    }
    ...
    public async Task WriteAsync(Game game, InstanceInstallReceipt receipt,
