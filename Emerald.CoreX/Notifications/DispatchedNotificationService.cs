...
public class DispatchedNotificationService : INotificationService
{
    ...
    {
        return RunOnUI(() => _inner.Create(title, message, progress, isIndeterminate, isCancellable));
    }
