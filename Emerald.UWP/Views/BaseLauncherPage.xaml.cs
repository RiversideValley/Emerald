...
using Emerald.UWP.Converters;
using Emerald.UWP.Resources;
using CmlLib.Utils;
using MojangAPI;
using Emerald.UWP.Dialogs;
using Emerald.UWP.DataTemplates;
...
namespace Emerald.UWP
{
    ...
    public sealed partial class BaseLauncherPage : Page
    {
        ...
        private void FabricResponse(Core.Emerald.FabricResponsoe responsoe)
        {
