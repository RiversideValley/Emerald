...
public sealed partial class ServerRow : UserControl
{
    public static readonly DependencyProperty ModelProperty = DependencyProperty.Register(nameof(Model),
        typeof(ServerRowViewModel), typeof(ServerRow), new PropertyMetadata(null, Changed));

    public ServerRowViewModel? Model
    {
        get => (ServerRowViewModel?)GetValue(ModelProperty);
    ...
    public void ShowOptions(MenuFlyout flyout)
    {
    ...
    {
        ((ServerRow)d).Root.DataContext = e.NewValue;
    }
    ...
    {
        Favorite?.Invoke(this, EventArgs.Empty);
    }
